        ...
        <div class="card-inner">
            <table class="datatable-init nk-tb-list nk-tb-ulist" data-auto-responsive="false">
                ...
                <tr class="nk-tb-item nk-tb-head">
                    ...
                    <th class="nk-tb-col tb-col-mb"><span class="sub-text">Mağaza Adı</span></th>
                ...
                <?php
                $say=0;
                while($mallscek=$malls->fetch(PDO::FETCH_ASSOC)) { $say++;
                $yetkililer=json_decode($mallscek[yetkilibilgileri]);
                    ...
                    <tr class="nk-tb-item">
                        <td class="nk-tb-col tb-col-mb">
                                                                     <span class="tb-amount">
                                                                         <?php echo $mallscek['market_id'] ?>
                                                                     </span>
                        </td>
                        <td class="nk-tb-col">
                            <?php echo $mallscek['market_name'] ?>
                        </td>

                        <td class="nk-tb-col tb-col-md">
                            <?=
                      $yetkililer->imzayetkilisiadi." ".
                      $yetkililer->imzayetkilisisoyadi;

                            ?>
                        </td>
                        <td class="nk-tb-col tb-col-lg">
                            <?php echo $mallscek['istelefonu'] ?>
                        </td>
                                    ...
                                    <div class="drodown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <ul class="link-list-opt no-bdr">
                                                ...
                                                <li><a href="#" data-toggle="modal" data-target="#modalDefault<?php echo $categoryayarcek['id'] ?>"><em class="icon ni ni-edit"></em><span>Ürünler</span></a></li>
                                                ...
                                                <li><a href="javascript:confirmDelete('Action/malls.php?MallsDelete=ok&MallsID=<?php echo $mallscek['market_id'];?>')"><em class="icon ni ni-trash"></em><span>Sil</span></a></li>
