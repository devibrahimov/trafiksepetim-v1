            ...
            <div class='row'>
                <div class="col-md-3 p-0">
                    <div class="magazaDiv">
                        ...
                        <span class="magazaSatisGelir"> <b>{{count($products)}} </b></span>
                    </div>
                </div>
                <div class="col-md-3 p-0">
                    <div class="magazaDiv">
                        <span class="magazaH1"><a href="{{route('stockdescendingproducts')}}">stokta azalan ürünler</a></span>

                        <span class="magazaSatisGelir"><b>
                                @php
                                    $count = 0;
                ...
                <div class="col-md-3 p-0">
                    <div class="magazaDiv">
                        <span class="magazaH1"><a href="{{route('offstatusproducts')}}">Yayında Olmayan Ürünler</a></span>
                        <span class="magazaSatisGelir"><b>
                                  @php
                                      $count = 0;
                                      foreach ($products->toArray() as $key=>$value) {
                ...
                <div class="col-md-3 p-0">
                    <div class="magazaDiv">
                        <span class="magazaH1"><a href="{{route('saleproducts')}}">indirimde olan ürünler</a></span>
                        <span class="magazaSatisGelir"><b>
                                 @php
                                     $count = 0;
                                     foreach ($products->toArray() as $key=>$value) {
                ...
                <div class="col-md-12 p-0">
                    <div class="magazaDiv">
                        <span class="magazaH1">tüm ürünler
                            <a  href="{{route('market-create-product')}}" class="btn btn-primary btn-lg pull-right mb-3" style="background-color: green;" >
                            ...
                            <table id="urunYonetimi" class="display" style="width:100%">
                                ...
                                @foreach($products as $product)
                                    ...
                                    <tr>
                                        <td>{{$product->name}}</td>
                                        <td  >
                                            <img src="/storage/uploads/thumbnail/malls/{{$product->market_id}}/productimages/small/{{$image->cover}}" width="50px" alt="">
                                            {{--  <img src="http://via.placeholder.com/50" alt="">--}}
                                        </td>
                                        <td>{{$product->price}}</td>
                                        <td>{{$product->sale_price==NULL?'indirimi yok' :$product->sale_price }}</td>
                                        <td>{{$product->stock}}</td>
                                        <td>
                                            <div class="custom-switch custom-switch-label-onoff custom-switch-xs pl-0">
                                                <input class="custom-switch-input showCheckoutHistory" data-productid="{{$product->id}}"
                                                       {{$product->status ==0? '' : 'checked'}}  id="example_{{$product->id}}" type="checkbox">
                                                <label class="custom-switch-btn" for="example_{{$product->id}}"></label>
                                            </div>
                                        </td>
                                        <td>
                                            ...
                                            <a href="{{route('market-edit-product', $product->id )}}" class="btn btn-primary btn-lg" style="background-color: green;"  >
                                            ...
                                            <form action="{{route('market-delete-product', $product->id )}}" method="post" id="delete-product" style="display: none;">
