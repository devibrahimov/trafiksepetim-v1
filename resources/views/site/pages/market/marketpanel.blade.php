                        ...
                        <div class="blog-post">
                            <div class="row">
                                ...
                                <div class=" wow fadeInUp col-12 ppChangeHover" id="coverPreviewimgdiv"  style="margin-bottom: 20px;">
                                     @if($market->market_cover_photo != NULL  )
                                        <div style="height:150px;background: url('/storage/uploads/thumbnail/malls/{{$market->market_id}}/profil/medium/{{$market->market_cover_photo}}') no-repeat;
...
{{--                                    <img class="img-responsive" id="coverPreviewimg"  src="/site/img/cover.jpg" alt="">--}}
                                ...
                                <div class="wow fadeInUp col-sm-2 col-xs-6 ppChangeHover" id="profilPreviewimgdiv">
                                     @if($market->market_profil_photo != NULL  )

                                        <div style="height:150px;background: url('/storage/uploads/thumbnail/malls/{{$market->market_id}}/profil/medium/{{$market->market_profil_photo}}') no-repeat;
                                            background-size: cover;background-position: center center !important;"></div>
                                    @else
                        ...
                        <div class="outer-bottom-xs blog-post outer-top-xs">
                            ...
                            <div class="row mt-5 recursiveCategoryContent">
                                <form id="" action="{{route('market_formupdate')}}" method="post" >
                                    <div class="col-md-6">
                                        <label for="input">Kullanıcı Adı</label>
                                        <input class="customFormInput" required type="text" name="user_name" value="{{$market->user_name}}">
                                    </div>
                                    @csrf
                                    <div class="col-md-6">
                                        <label for="input">E-Mail</label>
                                        <input class="customFormInput" disabled type="email" name="email" value="{{$market->email}}">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="customFormInput" disabled required type="text" value="{{$market->kep_address}}">
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="customFormInput" required type="numeric" name="ceptelefonu" value="{{$market->ceptelefonu}}">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="input">İş Telefonu</label>
                                        <input class="customFormInput" required type="numeric" name="istelefonu" value="{{$market->istelefonu}}">
                                    </div>
                                    <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select class="customFormInput" name="province" id="province"  >
                                            ...
                                            <option value="{{$province->id}}"{{$province->id == $market->il?'selected':''}} >{{$province->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <select class="customFormInput" name="district" id="districts">
                                            <option value="{{$market->ilce}}">{{$ilce->name}}</option>
                                        </select>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="input">Posta Kodu</label>
                                        <input class="customFormInput" required  name="postcode" type="text" value="{{$market->postcode}}">
                                    </div>
                                    <div class="col-md-6">
                                        <label for="input">Adres</label>
                                        <input class="customFormInput" required  name="address" type="text" value="{{$market->adress}}">
                                    </div>
                                    @php $hesapbilgileri = json_decode($market->hesapbilgileri)  @endphp
                                    <div class="col-md-6">
                                        <label for="input">Banka</label>
                                        <select class="customFormInput" name="bank"  >
                                            @php $banks = (new \App\Http\Controllers\Site\Market\MarketPagesController)->banks() @endphp
                                            @foreach($banks as $bank)
                                                <option value="{{$bank}}" {{ $bank== $hesapbilgileri->bank?'selected' : '' }}>{{$bank}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input class="customFormInput" required name="ibanno"  type="numeric" value="{{$hesapbilgileri->ibanno}}">
                                    </div>
                                    <div class="col-md-12">
                                        <label for="input">Hesap Sahibi Adı/Soyadı Ünvan</label>
                                        <input class="customFormInput" required type="text"  name="hesabsahibiadi" value="{{$hesapbilgileri->hesabsahibiadi}}">
                                    </div>
                                    <div class="col-md-6">
    ...
    <div class="modal fade" id="detay" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog modal-lg" role="document">
            <form action="{{route('changepasswd')}}" name="changepassword" method="post" class="modal-content" >
