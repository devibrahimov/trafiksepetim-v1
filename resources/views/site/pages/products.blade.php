                        ...
                        <div class="container">
                            <div class="breadcrumb-inner">
                                <ul class="list-inline list-unstyled">
                                    ...
                                    <li class='active'><a href="{{route('products')}}">Ürünler</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
@section('js')
    <script>
        ...
        function mycontent(mypage,filtersort,listtype){
            $('#loader_giph').show();
            $.post('{{route('scrollloadproducts')}}',{page:mypage,filtersort:filtersort,listtype:listtype,_token:'{{csrf_token()}}'},function (data) {
                if (data.length == 0){
