                                ...
                                <div class="profile-box">
                                    ...
                                    <div class="profile-info text-center mb-15">
                                        <div class="profile-img-wrap">
                                            <img class="inline-block mb-10" src="/site/img/profil.jpg" alt="user"/>
                                        </div>
                                        <h5 class="block mt-10 weight-500 capitalize-font txt-dark">{{$store->market_name}}</h5>
                                        <h6 class="block capitalize-font">
                                            {{$store->status ===0 ? 'onay bekliyor':  '' }}
                                        </h6>
                                    </div>
                                    <div class="social-info">
                                        <div class="row">
                                            <div class="col-xs-4 text-center">
                                                ...
                                                <span class="counts-text block">Ürün Sayısı</span>
                                            </div>
                                            <div class="col-xs-4 text-center">
                                                <span class="counts block head-font"><span class="counter-anim">246</span></span>
                                                <span class="counts-text block">Yıldız Puanı</span>
                                            </div>
                                            <div class="col-xs-4 text-center">
                                                <span class="counts block head-font"><span class="counter-anim">898</span></span>
                                                <span class="counts-text block">Şikayet Sayısı</span>
                                            </div>
                                        </div>
                                        <div class="button-list">
                                            <button class="btn btn-success btn-icon-anim btn-square btn-sm"><i class="fa fa-check"></i></button>
                                        ...
                                        </div>                                        <div id="myModal" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
